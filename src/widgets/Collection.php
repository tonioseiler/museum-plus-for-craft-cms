...
/**
 * MuseumPlus for CraftCMS Widget
 *
...
class Collection extends Widget
{
    ...
    {
        return Craft::getAlias("@furbo/museumplusforcraftcms/assetbundles/collectionwidget/dist/img/Collection-icon.svg");
    }
    ...
    public function getSettingsHtml(): ?string
    {
        return Craft::$app->getView()->renderTemplate(
            'museum-plus-for-craft-cms/_components/widgets/Collection_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(CollectionWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'museum-plus-for-craft-cms/_components/widgets/Collection_body',
            [
